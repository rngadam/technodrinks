...
Dans cette présentation de 20 minutes, les concepts de base de l'identité décentralisée seront introduits ainsi que leurs applications autour de l'agent Python Aries de Hyperledger (bientôt transféré à l'OpenWallet Foundation

<div class="pt-12">
  <span @click="$slidev.nav.next" class="px-2 py-1 rounded cursor-pointer" hover="bg-white bg-opacity-10">
    Appuyez espace pour la prochaine page <carbon:arrow-right class="inline"/>
  </span>
</div>
...
<v-drag-arrow pos="67,452,316,-2" two-way op70 />
